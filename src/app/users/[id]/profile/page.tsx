  ...
  return (
    <>
      <section className="mb-16">
        <Box className="h-[250px] relative bg-gray-400 bg-opacity-70 overflow-visible">
          <Flex
          ...
          <Flex className="absolute rounded-[50%] w-[140px] h-[140px] bottom-[-2rem] z-30 bg-white shadow-xl">
            {/* <Box variant="none" className="w-[80%] h-[80%] rounded-[50%]">
          </Box> */}
            <img
      ...
      <section>
        ...
        >
          ...
          {Array(10)
            ...
            .map((_, i) => (
              <Flex
                style={{ direction: "column", justify: "start", align: "start" }}
                as={Box}
                key={i}
